 ...
 */
class Version20180519223951 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE marque DROP FOREIGN KEY FK_5A6F91CE4103C75F');
        $this->addSql('DROP INDEX IDX_5A6F91CE4103C75F ON marque');
        $this->addSql('ALTER TABLE marque CHANGE id_offre offre_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE marque CHANGE offre_id id_offre INT DEFAULT NULL');
        $this->addSql('ALTER TABLE marque ADD CONSTRAINT FK_5A6F91CE4103C75F FOREIGN KEY (id_offre) REFERENCES offre (id)');
        $this->addSql('CREATE INDEX IDX_5A6F91CE4103C75F ON marque (id_offre)');
